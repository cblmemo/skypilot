...
class Trace(clouds.Cloud):
    """Trace Cloud

    Dummy cloud that reads a trace to determine the spot availability.
    """
    _REPR = 'Trace'
    ...
    def _get_feasible_launchable_resources(
        ...
        if accelerators is None:
            ...
            default_instance_type = Trace.get_default_instance_type(
                cpus=resources.cpus,
    ...
    def instance_type_exists(self, instance_type: str) -> bool:
        return catalog.instance_type_exists(instance_type, 'trace')

    def validate_region_zone(self, region: Optional[str], zone: Optional[str]):
        return catalog.validate_region_zone(region, zone, clouds='trace')
